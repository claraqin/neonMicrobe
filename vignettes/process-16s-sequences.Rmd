...
for (i in 1:loop_length) {
  ...
  filter_trackReads <- qualityFilter16S(fn_base, PATH_TRIMMED, PATH_FILTERED, MULTITHREAD, maxEE = c(MAX_EE_FWD, MAX_EE_REV), truncLen=220) # truncation lengths will be determined automatically using get_truncation_length()
...
saveRDS(seqtab_joined, "./data/NEON_16S_seqtab_nochim_SMALLSUBSET.Rds")
saveRDS(tax, "./data/NEON_16S_tax_SMALLSUBSET.Rds")
```
