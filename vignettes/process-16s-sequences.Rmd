...
```{r}
track <- combineReadTrackingTables16S(trim_trackReads, filter_trackReads, dada_out$track)
write.csv(track, file.path(NEONMICROBE_DIR_TRACKREADS(), "16S",
