...
r1_files <- list.files(file.path(NEONMICROBE_DIR_SEQUENCE(), "16S"), full.names=TRUE, pattern="_R1")
...
```{r, fig.width=3, fig.height=3}
r2_files <- list.files(file.path(NEONMICROBE_DIR_SEQUENCE(), "16S"), full.names=TRUE, pattern="_R2")
