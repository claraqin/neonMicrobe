...
#   knitr::opts_knit$set(
#   root.dir = "~/Documents/UCSC/Projects/NEON_soil_microbe_processing" # Update as necessary. Should refer to the absolute filepath of the project root directory (e.g. .../neonSoilMicrobeProcessing)
#   )
# }
...
#   )
# }
knitr::opts_knit$set(root.dir = "~/Documents/UCSC/Projects/NEON_soil_microbe_processing")
...
```{r}
meta_16s <- meta[grep("16S", meta$targetGene),]
meta_16s_qc <- qcMetadata(meta_16s)
```

```{r}
meta_its <- meta[grep("ITS", meta$targetGene),]
meta_its_qc <- qcMetadata(meta_its)
```

```{r}
meta <- rbind(meta_16s_qc, meta_its_qc)
```
...
fn0 <- file.path(outdir_sequence, meta$rawDataFileName)
