...
for (i in 1:loop_length) {
  ...
  filter_trackReads <- qualityFilter16S(fn_base, PATH_TRIMMED, PATH_FILTERED, MULTITHREAD, maxEE = c(MAX_EE_FWD, MAX_EE_REV), truncLen = NULL) # truncation lengths will be determined automatically using get_truncation_length()
