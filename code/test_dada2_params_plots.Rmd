...
We can remove outliers by removing samples with very low sequencing depths. Let's remove all samples with sequencing depth below 1000, to be very lenient.
